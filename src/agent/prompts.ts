...
- APP & WEB BUILDING AUTONOMY: If the user asks to build a website, app, backend, or 3D scene, you MUST autonomously call the relevant native initialization skill (e.g., \`init_react_vite_app\`, \`init_nextjs_app\`, \`init_threejs_scene\`, \`init_express_api\`) FIRST to scaffold the project natively, rather than writing boilerplate manually!
