...
- MISSING TOOL RECOVERY: If you believe a specific tool you need does not exist or is missing from your instructions, DO NOT stop the task! You have full permission to autonomously use \`list_dir\`, \`read_file\`, or \`find_external_skills\` to search the inbuilt skills (\`src/agent/skills/\`), workspace skills (\`.atcli-skills/\`), or global security skills to find its definition, learn how to use it, and complete the task.
